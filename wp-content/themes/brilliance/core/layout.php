...
function cpotheme_init_sidebar(){
	...
	$footer_columns = apply_filters('cpotheme_subfooter_columns', 4);
	if($footer_columns == '') $footer_columns = 4;
	for($count = 1; $count <= $footer_columns; $count++){
		...
		$footer_columns = apply_filters('cpotheme_subfooter_columns', 1);
	if($footer_columns == '') $footer_columns = 1;
	for($count = 1; $count <= $footer_columns; $count++){
		register_sidebar(array(
		'id' => 'footer-widgets-'.$count,
		'name' => __('Footer Widgets', 'cpocore').' '.$count,
