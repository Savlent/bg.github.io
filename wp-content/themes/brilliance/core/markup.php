...
if(!function_exists('cpotheme_footer')){
	function cpotheme_footer(){		
		...
		echo '<br /><a href="http://weboboi.ru/" title="обои для рабочего стола широкоформатные высокое качество бесплатно" target="_blank">обои на рабочий стол широкоформатные</a> ';
		echo ' <a href="http://www.cpothemes.com" target="_blank">CPOThemes</a>';
		echo '</div>';
	}
}
