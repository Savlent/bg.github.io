...
/* @galleries/view.twig */
class __TwigTemplate_2f7f06c3e94092031943ce2f6cda1bf4788a4f8e6382bc9980c63a230dc8fa2b extends Twig_Template
{
...
\t\t                <a href=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "generateUrl", array(0 => "galleries", 1 => "sort", 2 => array("gallery_id" => $this->getAttribute((isset($context["gallery"]) ? $context["gallery"] : null), "id", array()))), "method"), "html", null, true);
        echo "\"
\t\t                   class=\"button\">
...
\t\t\t\t\t\t\t";
        ...
        // line 72
        echo "\t\t\t\t\t\t\t";
        if (((($this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "isPro", array(), "method") == true) && $this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "attributes", array(), "any", true, true)) && (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "attributes", array()), "order", array())) > 0))) {
            // line 73
            echo "\t\t\t\t\t\t\t\t<optgroup label=\"Add Attributes\">
\t\t\t\t\t\t\t\t\t";
            // line 74
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "attributes", array()), "order", array()));
...
\t\t\t\t\t\t\t<select id=\"gg-attribute-values\" style=\"height: 34px; width: 150px;\" data-values=\"";
            // line 83
            echo twig_escape_filter($this->env, twig_jsonencode_filter($this->getAttribute((isset($context["gallery"]) ? $context["gallery"] : null), "attributes", array())), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t</select>
\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["obj"]) {
            // line 112
            echo "\t\t\t\t\t\t\t\t";
            if (($this->getAttribute($context["obj"], "id", array()) != $this->getAttribute((isset($context["gallery"]) ? $context["gallery"] : null), "id", array()))) {
                // line 113
                echo "\t\t\t\t\t\t\t\t\t<option value=\"";
...
\t\t\t\t\t\t";
        // line 176
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["gallery"]) ? $context["gallery"] : null), "photos", array())) > 0)) {
            // line 177
            echo "\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t";
        // line 182
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute((isset($context["gallery"]) ? $context["gallery"] : null), "photos", array())), "html", null, true);
        echo " ";
...
";
    ...
    ";
        // line 221
        echo $context["importTypes"]->getview_dialogs($this->getAttribute((isset($context["gallery"]) ? $context["gallery"] : null), "id", array()));
        echo "
...
\t<div id=\"ggImageMetaDialog\" title=\"";
    ...
    ";
        ...
        \t\t\t";
            // line 443
            if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "attributes", array(), "any", true, true) && (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "attributes", array()), "order", array())) > 0))) {
                // line 444
                echo "\t   \t\t\t\t\t";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "attributes", array()), "order", array()));
...
\t\t\t\t\t\t\t";
                // line 461
                if (($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "attributes", array()), "enabled", array()) != "false")) {
                    // line 462
                    echo "\t\t\t\t\t\t\t\t<td colspan=\"3\">
\t\t\t\t\t\t\t\t\t";
                    // line 463
...
\t\t\t\t\t\t\t\t";
    ...
    {
        return new Twig_Source("", "@galleries/view.twig", "C:\\OSPanel\\OSPanel\\domains\\wptest\\wp-content\\plugins\\gallery-by-supsystic\\src\\GridGallery\\Galleries\\views\\view.twig");
    }
}
